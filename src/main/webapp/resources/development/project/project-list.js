(function () {
    ...
    var initSelect = function (_data) {
        ...
        $("#yearCode").empty();
        $("<option></option>") .val('-1') .text("请选择...").appendTo($("#yearCode"));
        ...
        $("#customerId").empty();
        $("<option></option>") .val('-1') .text("请选择...").appendTo($("#customerId"));
        $.each(yearCodeItems, function (i, item) {
            $("<option></option>")
                .val(item["natrualkey"])
                .text(item["name"])
        ...
        $("#areaId").empty();
        $("<option></option>") .val('-1') .text("请选择...").appendTo($("#areaId"));
        ...
        $("#seriesId").empty();
        $("<option></option>") .val('-1') .text("请选择...").appendTo($("#seriesId"));
