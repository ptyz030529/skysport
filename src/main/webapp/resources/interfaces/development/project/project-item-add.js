...
(function () {
    ...
    var reloadDetailSelectData = function () {
        $.sendRestFulAjax(path + project_selectURL, null, 'GET', 'json', initSelectCallBack);
    }
    ...
    var initOther = function () {
        ...
        if (natrualkey != '') {
            $.sendRestFulAjax(path + project_infoURL+ natrualkey, null, 'GET', 'json', initFormFields);
        }
    ...
    var doSaveAction = function () {
        ...
        if (natrualkey === '' || natrualkey === 'null') {
            url = path + project_newURL;
        } else {
            url = path + project_editURL;
        }
