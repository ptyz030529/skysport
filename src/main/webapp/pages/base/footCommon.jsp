...
<script type="text/javascript" src="<%=path%>/resources/js/jquery.easy-pie-chart.min.js"></script>
<script type="text/javascript" src="<%=path%>/resources/js/jquery.sparkline.min.js"></script>
<script type="text/javascript" src="<%=path%>/resources/js/flot/jquery.flot.min.js"></script>
<script type="text/javascript" src="<%=path%>/resources/js/flot/jquery.flot.pie.min.js"></script>
<script type="text/javascript" src="<%=path%>/resources/js/flot/jquery.flot.resize.min.js"></script>
...
<script type="text/javascript" src="<%=path%>/resources/js/chosen.jquery.min.js"></script>
...
<script type="text/javascript" src="<%=path%>/resources/js/jquery.knob.min.js"></script>
<script type="text/javascript" src="<%=path%>/resources/js/jquery.autosize.min.js"></script>
