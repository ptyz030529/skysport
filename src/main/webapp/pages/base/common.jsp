...
<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/jquery-ui-1.10.3.custom.min.css"/>
...
<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/bootstrap-timepicker.css"/>
...
<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/bootstrap-switch.css"/>
