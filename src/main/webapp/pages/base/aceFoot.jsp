...
<!-- ace scripts -->
<script src="<%=path%>/resources/js/ace/elements.scroller.js"></script>
<script src="<%=path%>/resources/js/ace/elements.colorpicker.js"></script>
<script src="<%=path%>/resources/js/ace/elements.fileinput.js"></script>
...
<script src="<%=path%>/resources/js/ace/ace.ajax-content.js"></script>
<script src="<%=path%>/resources/js/ace/ace.touch-drag.js"></script>
