...
<div class="page-content">
    ...
    <div class="page-header">
        <h1>
            系统管理
            <small><i class="icon-double-angle-right"></i> 膜的厚度信息</small>
        </h1>
    </div>
    <!-- PAGE CONTENT BEGINS -->
    <div class="row">
...
<script type="text/javascript" src="<%=path%>/resources/interfaces/system/material/mt/mt.js"></script>
