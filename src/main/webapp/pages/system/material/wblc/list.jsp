...
<div class="page-content">
    ...
    <div class="page-header">
        <h1>
            系统管理
            <small><i class="icon-double-angle-right"></i> 贴膜或涂层工艺信息</small>
        </h1>
    </div>
    <!-- PAGE CONTENT BEGINS -->
    <div class="row">
...
<script type="text/javascript" src="<%=path%>/resources/interfaces/system/material/wblc/wblc.js"></script>
