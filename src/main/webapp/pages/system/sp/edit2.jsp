                        ...
                        <form id="defaultForm" method="post" class="form-horizontal" action="edit">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="form-control" id="cooperationTime"
                                               name="cooperationTime" placeholder="合作时间"
...
<script type="text/javascript" src="<%=path%>/resources/interfaces/system/sp/sp.js"/>