...
<script type="text/javascript">
    ...
    function downoffer(natrualkeys) {
        window.location.href = path + "/development/project_item/download_offer/" + natrualkeys;
    }
...
<script type="text/javascript" src="<%=path%>/resources/interfaces/development/project/project-item-list.js"></script>