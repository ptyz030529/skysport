...
public class MembraneThicknessAction extends TableListQueryAction<String, Object, MembraneThicknessInfo> {
    ...
    public Map<String, Object> search(HttpServletRequest request)
        ...
        DataTablesInfo dataTablesInfo = convertToDataTableQrInfo(DictionaryTypeConstant.MT_TABLE_COLUMN, request);
        // 总记录数
        ...
        List<MembraneThicknessInfo> areaInfos = membraneThicknessService.searchInfos(dataTablesInfo);
    ...
    public Map<String, Object> add(MembraneThicknessInfo areaInfo, HttpServletRequest request,
        ...
        //设置ID
        areaInfo.setNatrualkey(CommonHelper.SINGLETONE.getNextSeqNo(TableNameConstant.MT_INFO, currentNo, incrementNumber));
    ...
    @ResponseBody
    public MembraneThicknessInfo queryCustomerNo(@PathVariable String natrualKey, HttpServletRequest request, HttpServletResponse reareaonse) {
    ...
    public Map<String, Object> querySelectList(HttpServletRequest request) {
        ...
        List<CommonBean> commonBeans = membraneThicknessService.querySelectList(name);
        Map<String, Object> resultMap = new HashMap<String, Object>();
