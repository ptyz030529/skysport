...
public class MembraneThicknessAction extends BaseAction<String, Object, MembraneThicknessInfo> {
    ...
    public Map<String, Object> add(MembraneThicknessInfo areaInfo, HttpServletRequest request,
        ...
        //设置ID
        areaInfo.setNatrualkey(BuildSeqNoHelper.SINGLETONE.getNextSeqNo(TableNameConstant.MT_INFO, currentNo, incrementNumber));
    ...
    public Map<String, Object> querySelectList(HttpServletRequest request) {
        ...
        List<SelectItem> commonBeans = membraneThicknessService.querySelectList(name);
        Map<String, Object> resultMap = new HashMap<String, Object>();
