...
import com.skysport.inerfaces.model.system.material.impl.helper.WaterVapourPermeabilityServiceHelper;
...
public class WaterVapourPermeabilityAction extends BaseAction<String, Object, WaterVapourPermeabilityInfo> {
    ...
    public Map<String, Object> search(HttpServletRequest request) {
        ...
        DataTablesInfo dataTablesInfo = convertToDataTableQrInfo(DictionaryKeyConstant.WVP_TABLE_COLUMN, request);
        // 总记录数
    ...
    public Map<String, Object> add(WaterVapourPermeabilityInfo areaInfo, HttpServletRequest request,
        ...
        //设置ID
        areaInfo.setNatrualkey(BuildSeqNoHelper.SINGLETONE.getNextSeqNo(TableNameConstant.WVP_INFO, currentNo, incrementNumber));
