...
public class SpecificationAction extends TableListQueryAction<String, Object, SpecificationInfo> {
    ...
    public Map<String, Object> search(HttpServletRequest request)
        ...
        DataTablesInfo dataTablesInfo = convertToDataTableQrInfo(DictionaryTypeConstant.SPECIFICATION_TABLE_COLUMN, request);
        // 总记录数
        int recordsTotal = specificationService.listInfosCounts();
        int recordsFiltered = recordsTotal;
        if (!StringUtils.isBlank(dataTablesInfo.getSearchValue())) {
            recordsFiltered = specificationService.listFilteredInfosCounts(dataTablesInfo);
        }
        int draw = Integer.parseInt(request.getParameter("draw"));
        List<SpecificationInfo> areaInfos = specificationService.searchInfos(dataTablesInfo);
    ...
    public Map<String, Object> add(SpecificationInfo areaInfo, HttpServletRequest request,
        ...
        //设置ID
        areaInfo.setNatrualkey(CommonHelper.SINGLETONE.getNextSeqNo(TableNameConstant.SPECIFICATION_INFO, currentNo, incrementNumber));
    ...
    @ResponseBody
    public SpecificationInfo queryCustomerNo(@PathVariable String natrualKey, HttpServletRequest request, HttpServletResponse reareaonse) {
        SpecificationInfo areaInfo = (SpecificationInfo) specificationService.queryInfoByNatrualKey(natrualKey);
        return areaInfo;
    }
    ...
    public Map<String, Object> querySelectList(HttpServletRequest request) {
        ...
        List<CommonBean> commonBeans = specificationService.querySelectList(name);
        Map<String, Object> resultMap = new HashMap<String, Object>();
