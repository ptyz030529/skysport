...
import com.skysport.inerfaces.model.system.material.impl.helper.ColorOfMembraneCoatingServiceHelper;
...
public class ColorOfMembraneCoatingAction extends BaseAction<String, Object, ColorOfMembraneCoatingInfo> {
    ...
    public Map<String, Object> search(HttpServletRequest request) {
        ...
        DataTablesInfo dataTablesInfo = convertToDataTableQrInfo(DictionaryKeyConstant.COMC_TABLE_COLUMN, request);
        // 总记录数
