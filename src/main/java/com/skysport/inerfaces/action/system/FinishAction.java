...
public class FinishAction extends BaseAction<String, Object, FinishInfo> {
    ...
    public Map<String, Object> search(HttpServletRequest request)
        ...
        DataTablesInfo dataTablesInfo = convertToDataTableQrInfo(DictionaryKeyConstant.FINISH_TABLE_COLUMN, request);
        // 总记录数
    ...
    public Map<String, Object> add(FinishInfo areaInfo, HttpServletRequest request,
        ...
        //设置ID
        areaInfo.setNatrualkey(BuildSeqNoHelper.SINGLETONE.getNextSeqNo(TableNameConstant.FINISH_INFO, currentNo, incrementNumber));
