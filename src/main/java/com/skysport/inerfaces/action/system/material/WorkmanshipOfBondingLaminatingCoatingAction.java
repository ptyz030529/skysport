...
public class WorkmanshipOfBondingLaminatingCoatingAction extends TableListQueryAction<String, Object, WorkmanshipOfBondingLaminatingCoatingInfo> {
    ...
    public Map<String, Object> search(HttpServletRequest request)
        ...
        DataTablesInfo dataTablesInfo = convertToDataTableQrInfo(DictionaryTypeConstant.WBLC_TABLE_COLUMN, request);
        // 总记录数
        ...
        List<WorkmanshipOfBondingLaminatingCoatingInfo> areaInfos = workmanshipOfBondingLaminatingCoatingService.searchInfos(dataTablesInfo);
    ...
    public Map<String, Object> querySelectList(HttpServletRequest request) {
        ...
        List<CommonBean> commonBeans = workmanshipOfBondingLaminatingCoatingService.querySelectList(name);
        Map<String, Object> resultMap = new HashMap<String, Object>();
