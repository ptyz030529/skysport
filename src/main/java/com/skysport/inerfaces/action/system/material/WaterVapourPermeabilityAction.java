...
public class WaterVapourPermeabilityAction extends TableListQueryAction<String, Object, WaterVapourPermeabilityInfo> {
    ...
    public Map<String, Object> search(HttpServletRequest request)
        ...
        List<WaterVapourPermeabilityInfo> areaInfos = waterVapourPermeabilityService.searchInfos(dataTablesInfo);
    ...
    public Map<String, Object> querySelectList(HttpServletRequest request) {
        ...
        List<CommonBean> commonBeans = waterVapourPermeabilityService.querySelectList(name);
        Map<String, Object> resultMap = new HashMap<String, Object>();
