...
public class DyeAction extends TableListQueryAction<String, Object, DyeInfo> {
    ...
    public Map<String, Object> search(HttpServletRequest request)
        ...
        List<DyeInfo> areaInfos = dyeService.searchInfos(dataTablesInfo);
    ...
    public Map<String, Object> add(DyeInfo areaInfo, HttpServletRequest request,
        ...
        //设置ID
        areaInfo.setNatrualkey(CommonHelper.SINGLETONE.getNextSeqNo(TableNameConstant.DYE_INFO, currentNo, incrementNumber));
    ...
    public Map<String, Object> querySelectList(HttpServletRequest request) {
        ...
        List<CommonBean> commonBeans = dyeService.querySelectList(name);
        Map<String, Object> resultMap = new HashMap<String, Object>();
