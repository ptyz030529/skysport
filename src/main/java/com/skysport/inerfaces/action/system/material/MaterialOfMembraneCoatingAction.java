...
public class MaterialOfMembraneCoatingAction extends TableListQueryAction<String, Object, MaterialOfMembraneCoatingInfo> {
    ...
    public Map<String, Object> search(HttpServletRequest request)
        ...
        DataTablesInfo dataTablesInfo = convertToDataTableQrInfo(DictionaryTypeConstant.MOMC_TABLE_COLUMN, request);
        // 总记录数
        ...
        List<MaterialOfMembraneCoatingInfo> areaInfos = materialOfMembraneCoatingService.searchInfos(dataTablesInfo);
    ...
    public Map<String, Object> add(MaterialOfMembraneCoatingInfo areaInfo, HttpServletRequest request,
        ...
        //设置ID
        areaInfo.setNatrualkey(CommonHelper.SINGLETONE.getNextSeqNo(TableNameConstant.MOMC_INFO, currentNo, incrementNumber));
    ...
    public Map<String, Object> querySelectList(HttpServletRequest request) {
        ...
        List<CommonBean> commonBeans = materialOfMembraneCoatingService.querySelectList(name);
        Map<String, Object> resultMap = new HashMap<String, Object>();
