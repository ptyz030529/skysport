...
import com.skysport.core.constant.SecretKeyConstant;
import com.skysport.core.instance.DictionaryInfo;
import com.skysport.core.utils.AESUitls;
...
public enum UserInfoHelper {
     ...
     * @param userinfoInfo
     */
    public void encriptPwd(UserInfo userinfoInfo) {
        String pwd = userinfoInfo.getUserPwd();
        userinfoInfo.setUserPwd(AESUitls.decrypt(SecretKeyConstant.PWD_KEY, pwd));
    }
}
