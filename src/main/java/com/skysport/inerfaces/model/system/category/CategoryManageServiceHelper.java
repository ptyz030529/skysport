...
public enum CategoryManageServiceHelper {
    ...
    public void refreshSelect(ApplicationContext appContext) {
        ...
        List<SelectItem2> categoryAItems = categoryManageService.querySelectListByLevelId(ApplicationConstant.CATEGORY_A_LEVEL);
        List<SelectItem2> categoryBItems = categoryManageService.querySelectListByLevelId(ApplicationConstant.CATEGORY_B_LEVEL);
