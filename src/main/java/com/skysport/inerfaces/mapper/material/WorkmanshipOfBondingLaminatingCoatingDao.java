 ...
 */
@Component("workmanshipOfBondingLaminatingCoatingDao")
public interface WorkmanshipOfBondingLaminatingCoatingDao extends CommonDao<WorkmanshipOfBondingLaminatingCoatingInfo> {
}
